(() => {
            ...
            379: (e, n, t) => {
                ...
                function s(e, n) {
                    for (var t = {}, r = [], o = 0; o < e.length; o++) {
                        ...
                        -1 !== d ? (i[d].references++, i[d].updater(f)) : i.push({ identifier: l, updater: m(f, n), references: 1 }), r.push(l);
                    }
                    return r;
                }
                function u(e) {
                ...
                function m(e, n) {
                    ...
                    if (n.singleton) {
                        var a = h++;
                        (t = p || (p = u(n))), (r = f.bind(null, t, a, !1)), (o = f.bind(null, t, a, !0));
                    } else
                        (t = u(n)),
                            (r = v.bind(null, t, n)),
                            (o = function () {
    ...
    (t.n = (e) => {
        ...
        (() => {
            ...
            r.Z.locals;
            !(function (e) {
                g('Creando etiqueta h1');
                var n = document.createElement('h1');
                (n.innerText = 'Hola, '.concat(e, '!!')), document.body.append(n);
            })('Gustavo');
        })();
})();
